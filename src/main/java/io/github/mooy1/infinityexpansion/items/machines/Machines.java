...
public final class Machines {
    ...
    public static final SlimefunItemStack ADVANCED_DUST_EXTRACTOR = new SlimefunItemStack(
            "ADVANCED_DUST_EXTRACTOR",
            Material.FURNACE,
            "&cAdvanced &8Dust Extractor",
            "&7Converts cobble into dusts",
            "",
            MachineLore.speed(4),
            MachineLore.energyPerSecond(480)
    );
    public static final SlimefunItemStack VOID_DUST_EXTRACTOR = new SlimefunItemStack(
            "VOID_DUST_EXTRACTOR",
            Material.FURNACE,
            "&8&lVoid &8Dust Extractor",
            "&7Converts cobble into dusts",
            "",
            MachineLore.speed(16),
            MachineLore.energyPerSecond(960)
    );
    ...
    public static final SlimefunItemStack ADVANCED_INGOT_FORMER = new SlimefunItemStack(
            "ADVANCED_INGOT_FORMER",
            Material.FURNACE,
            "&cAdvanced &8Ingot Former",
            "&7Forms ingots from dusts",
            "",
            MachineLore.speed(4),
            MachineLore.energyPerSecond(480)
    );
    public static final SlimefunItemStack VOID_INGOT_FORMER = new SlimefunItemStack(
            "VOID_INGOT_FORMER",
            Material.FURNACE,
            "&8&lVoid &8Ingot Former",
            "&7Forms ingots from dusts",
            "",
            MachineLore.speed(16),
            MachineLore.energyPerSecond(960)
    ...
    public static final SlimefunItemStack VOID_COBBLE = new SlimefunItemStack(
            "VOID_COBBLE_GEN",
            Material.SMOOTH_STONE,
            "&8&lVoid &8Cobble Generator",
            "",
    ...
    public static final SlimefunItemStack ADVANCED_SINGULARITY_CONSTRUCTOR = new SlimefunItemStack(
            "ADVANCED_SINGULARITY_CONSTRUCTOR",
            Material.QUARTZ_BRICKS,
            "&cAdvanced &fSingularity Constructor",
            "&7Condenses large amounts of resources",
            "",
            MachineLore.speed(4),
            MachineLore.energyPerSecond(240)
    );
    public static final SlimefunItemStack VOID_SINGULARITY_CONSTRUCTOR = new SlimefunItemStack(
            "VOID_SINGULARITY_CONSTRUCTOR",
            Material.QUARTZ_BRICKS,
            "&8&lVoid &fSingularity Constructor",
            "&7Condenses large amounts of resources",
            "",
            MachineLore.speed(16),
            MachineLore.energyPerSecond(480)
    ...
    public static final SlimefunItemStack ADVANCED_VOID_HARVESTER = new SlimefunItemStack(
            ...
            Material.OBSIDIAN,
            "&cAdvanced &8Void Harvester",
            "&7Slowly harvests &8Void &7Bits from nothing...",
            "",
            MachineLore.speed(4),
            MachineLore.energyPerSecond(240)
    );
    public static final SlimefunItemStack VOID_VOID_HARVESTER = new SlimefunItemStack(
            "VOID_VOID_HARVESTER",
            Material.OBSIDIAN,
            "&8&lVoid &8Void Harvester",
            "&7Slowly harvests &8Void &7Bits from nothing...",
            "",
            MachineLore.speed(16),
            MachineLore.energyPerSecond(480)
    ...
    public static void setup(InfinityExpansion plugin) {
        ...
        new VoidHarvester(Groups.ADVANCED_MACHINES, ADVANCED_VOID_HARVESTER, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
                Materials.MACHINE_PLATE, Materials.MAGSTEEL_PLATE, Materials.MACHINE_CIRCUIT,
                VOID_HARVESTER, Materials.MACHINE_CORE, VOID_HARVESTER,
                Materials.MACHINE_CIRCUIT, Materials.MAGSTEEL_PLATE, Materials.MACHINE_PLATE
        }, 4).energyPerTick(240).register(plugin);
        new VoidHarvester(Groups.VOID_MACHINES, VOID_VOID_HARVESTER, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
                Materials.MACHINE_PLATE, Materials.MACHINE_CORE, Materials.MACHINE_CIRCUIT,
                ADVANCED_VOID_HARVESTER, Materials.VOID_BLOCK, ADVANCED_VOID_HARVESTER,
                Materials.MACHINE_CIRCUIT, Materials.MACHINE_CORE, Materials.MACHINE_PLATE
        }, 16).energyPerTick(480).register(plugin);
        ...
        new SingularityConstructor(Groups.ADVANCED_MACHINES, ADVANCED_SINGULARITY_CONSTRUCTOR, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
                Materials.MACHINE_PLATE, Materials.MAGSTEEL_PLATE, Materials.MACHINE_CIRCUIT,
                SINGULARITY_CONSTRUCTOR, Materials.MACHINE_CORE, SINGULARITY_CONSTRUCTOR,
                Materials.MACHINE_CIRCUIT, Materials.MAGSTEEL_PLATE, Materials.MACHINE_PLATE
        }).speed(4).energyPerTick(240).register(plugin);
        new SingularityConstructor(Groups.VOID_MACHINES, VOID_SINGULARITY_CONSTRUCTOR, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
                Materials.MACHINE_PLATE, Materials.MACHINE_CORE, Materials.MACHINE_CIRCUIT,
                ADVANCED_SINGULARITY_CONSTRUCTOR, Materials.VOID_BLOCK, ADVANCED_SINGULARITY_CONSTRUCTOR,
                Materials.MACHINE_CIRCUIT, Materials.MACHINE_CORE, Materials.MACHINE_PLATE
        }).speed(16).energyPerTick(480).register(plugin);
        new SingularityConstructor(Groups.INFINITY_CHEAT, INFINITY_CONSTRUCTOR, InfinityWorkbench.TYPE, new ItemStack[] {
                ...
                null, Materials.VOID_INGOT, ADVANCED_SINGULARITY_CONSTRUCTOR, ADVANCED_SINGULARITY_CONSTRUCTOR, Materials.VOID_INGOT, null,
                null, Materials.VOID_INGOT, ADVANCED_SINGULARITY_CONSTRUCTOR, ADVANCED_SINGULARITY_CONSTRUCTOR, Materials.VOID_INGOT, null,
        ...
        new MaterialGenerator(Groups.VOID_MACHINES, VOID_COBBLE, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
                Materials.MAGSTEEL_PLATE, ADVANCED_COBBLE, Materials.MAGSTEEL_PLATE,
                new ItemStack(Material.ICE), Materials.COBBLE_4, new ItemStack(Material.OBSIDIAN),
                Materials.MACHINE_CIRCUIT, ADVANCED_COBBLE, Materials.MACHINE_CIRCUIT
        }).material(Material.COBBLESTONE).speed(32).energyPerTick(300).register(plugin);
        ...
        RandomizedItemStack fourDust = new RandomizedItemStack(
                new SlimefunItemStack(SlimefunItems.COPPER_DUST, 4),
                new SlimefunItemStack(SlimefunItems.ZINC_DUST, 4),
                new SlimefunItemStack(SlimefunItems.TIN_DUST, 4),
                new SlimefunItemStack(SlimefunItems.ALUMINUM_DUST, 4),
                new SlimefunItemStack(SlimefunItems.LEAD_DUST, 4),
                new SlimefunItemStack(SlimefunItems.SILVER_DUST, 4),
                new SlimefunItemStack(SlimefunItems.GOLD_DUST, 4),
                new SlimefunItemStack(SlimefunItems.IRON_DUST, 4),
                new SlimefunItemStack(SlimefunItems.MAGNESIUM_DUST, 4)
        );

        new MachineBlock(Groups.ADVANCED_MACHINES, ADVANCED_DUST_EXTRACTOR, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
                Materials.MACHINE_PLATE, Materials.MAGSTEEL_PLATE, Materials.MACHINE_CIRCUIT,
                DUST_EXTRACTOR, Materials.MACHINE_CORE, DUST_EXTRACTOR,
                Materials.MACHINE_CIRCUIT, Materials.MAGSTEEL_PLATE, Materials.MACHINE_PLATE,
        }).ticksPerOutput(1).addRecipe(fourDust, new ItemStack(Material.COBBLESTONE, 8))
                .addRecipe(fourDust, new ItemStack(Material.ANDESITE, 8))
                .addRecipe(fourDust, new ItemStack(Material.STONE, 8))
                .addRecipe(fourDust, new ItemStack(Material.DIORITE, 8))
                .addRecipe(fourDust, new ItemStack(Material.GRANITE, 8))
        ...
        new MachineBlock(Groups.VOID_MACHINES, VOID_DUST_EXTRACTOR, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
                Materials.MACHINE_PLATE, Materials.MACHINE_CORE, Materials.MACHINE_CIRCUIT,
                ADVANCED_DUST_EXTRACTOR, Materials.VOID_BLOCK, ADVANCED_DUST_EXTRACTOR,
                Materials.MACHINE_CIRCUIT, Materials.MACHINE_CORE, Materials.MACHINE_PLATE,
        }).ticksPerOutput(1).addRecipe(sixteenDust, new ItemStack(Material.COBBLESTONE, 32))
                .addRecipe(sixteenDust, new ItemStack(Material.ANDESITE, 32))
                .addRecipe(sixteenDust, new ItemStack(Material.STONE, 32))
                .addRecipe(sixteenDust, new ItemStack(Material.DIORITE, 32))
                .addRecipe(sixteenDust, new ItemStack(Material.GRANITE, 32))
        ...
        new MachineBlock(Groups.INFINITY_CHEAT, INFINITY_DUST_EXTRACTOR, InfinityWorkbench.TYPE, new ItemStack[] {
                ...
                Materials.VOID_INGOT, Materials.INFINITE_INGOT, ADVANCED_DUST_EXTRACTOR, ADVANCED_DUST_EXTRACTOR, Materials.INFINITE_INGOT, Materials.VOID_INGOT,
                Materials.VOID_INGOT, Materials.INFINITE_INGOT, ADVANCED_DUST_EXTRACTOR, ADVANCED_DUST_EXTRACTOR, Materials.INFINITE_INGOT, Materials.VOID_INGOT,
                Materials.VOID_INGOT, Materials.INFINITE_INGOT, ADVANCED_DUST_EXTRACTOR, ADVANCED_DUST_EXTRACTOR, Materials.INFINITE_INGOT, Materials.VOID_INGOT,
                Materials.VOID_INGOT, Materials.VOID_INGOT, Materials.VOID_INGOT, Materials.VOID_INGOT, Materials.VOID_INGOT, Materials.VOID_INGOT,
        ...
        new MachineBlock(Groups.ADVANCED_MACHINES, ADVANCED_INGOT_FORMER, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
                Materials.MACHINE_PLATE, Materials.MAGSTEEL_PLATE,  Materials.MACHINE_CIRCUIT,
                INGOT_FORMER, Materials.MACHINE_CORE, INGOT_FORMER,
                Materials.MACHINE_CIRCUIT, Materials.MAGSTEEL_PLATE, Materials.MACHINE_PLATE,
        ...
        new MachineBlock(Groups.VOID_MACHINES, VOID_INGOT_FORMER, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
                Materials.MACHINE_PLATE, Materials.MACHINE_CORE, Materials.MACHINE_CIRCUIT,
                ADVANCED_INGOT_FORMER, Materials.VOID_BLOCK, ADVANCED_INGOT_FORMER,
                Materials.MACHINE_CIRCUIT, Materials.MACHINE_CORE, Materials.MACHINE_PLATE,
        }).addRecipe(new SlimefunItemStack(SlimefunItems.COPPER_INGOT, 16), new SlimefunItemStack(SlimefunItems.COPPER_DUST, 32))
                .addRecipe(new SlimefunItemStack(SlimefunItems.ZINC_INGOT, 16), new SlimefunItemStack(SlimefunItems.ZINC_DUST, 32))
                .addRecipe(new SlimefunItemStack(SlimefunItems.TIN_INGOT, 16), new SlimefunItemStack(SlimefunItems.TIN_DUST, 32))
                .addRecipe(new SlimefunItemStack(SlimefunItems.ALUMINUM_INGOT, 16), new SlimefunItemStack(SlimefunItems.ALUMINUM_DUST, 32))
                .addRecipe(new SlimefunItemStack(SlimefunItems.LEAD_INGOT, 16), new SlimefunItemStack(SlimefunItems.LEAD_DUST, 32))
                .addRecipe(new SlimefunItemStack(SlimefunItems.SILVER_INGOT, 16), new SlimefunItemStack(SlimefunItems.SILVER_DUST, 32))
                .addRecipe(new SlimefunItemStack(SlimefunItems.GOLD_24K, 4), new SlimefunItemStack(SlimefunItems.GOLD_DUST, 32))
                .addRecipe(new ItemStack(Material.IRON_INGOT, 16), new SlimefunItemStack(SlimefunItems.IRON_DUST, 32))
                .addRecipe(new SlimefunItemStack(SlimefunItems.MAGNESIUM_INGOT, 16), new SlimefunItemStack(SlimefunItems.MAGNESIUM_DUST, 32))
                .ticksPerOutput(1).energyPerTick(960).register(plugin);

        new MachineBlock(Groups.INFINITY_CHEAT, INFINITY_INGOT_FORMER, InfinityWorkbench.TYPE, new ItemStack[] {
                Materials.VOID_INGOT, Materials.VOID_INGOT, Materials.VOID_INGOT, Materials.VOID_INGOT, Materials.VOID_INGOT, Materials.VOID_INGOT,
                Materials.VOID_INGOT, Materials.INFINITE_INGOT, Materials.INFINITE_CIRCUIT, Materials.INFINITE_CIRCUIT, Materials.INFINITE_INGOT, Materials.VOID_INGOT,
                Materials.VOID_INGOT, Materials.INFINITE_INGOT, ADVANCED_INGOT_FORMER, ADVANCED_INGOT_FORMER, Materials.INFINITE_INGOT, Materials.VOID_INGOT,
                Materials.VOID_INGOT, Materials.INFINITE_INGOT, ADVANCED_INGOT_FORMER, ADVANCED_INGOT_FORMER, Materials.INFINITE_INGOT, Materials.VOID_INGOT,
                Materials.VOID_INGOT, Materials.INFINITE_INGOT, ADVANCED_INGOT_FORMER, ADVANCED_INGOT_FORMER, Materials.INFINITE_INGOT, Materials.VOID_INGOT,
                Materials.VOID_INGOT, Materials.VOID_INGOT, Materials.VOID_INGOT, Materials.VOID_INGOT, Materials.VOID_INGOT, Materials.VOID_INGOT,
