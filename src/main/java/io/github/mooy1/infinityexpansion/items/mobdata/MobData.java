...
public final class MobData {
    ...
    public static final SlimefunItemStack WARDEN = MobDataCard.create("Warden", MobDataTier.MINI_BOSS);
    ...
    public static void setup(InfinityExpansion plugin) {
        ...
        new MobDataCard(WARDEN, MobDataTier.MINI_BOSS, new ItemStack[] {
                new ItemStack(Material.CYAN_WOOL, 64), new ItemStack(Material.SCULK_CATALYST, 16), new ItemStack(Material.DEEPSLATE, 64),
                new ItemStack(Material.SCULK_VEIN, 32), EMPTY_DATA_CARD, new ItemStack(Material.SCULK_VEIN, 32),
                new ItemStack(Material.DEEPSLATE, 64), new ItemStack(Material.SCULK_CATALYST, 16), new ItemStack(Material.CYAN_WOOL, 64)
        }).addDrop(Material.SCULK_CATALYST, 2, 1).register(plugin);
