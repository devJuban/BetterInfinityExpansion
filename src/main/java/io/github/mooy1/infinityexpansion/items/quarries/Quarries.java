...
public final class Quarries {
    ...
    public static void setup(InfinityExpansion plugin) {
        ...
        }, 1, section.getBoolean("cobblestone") ? 6 : 1, outputs.toArray(new Material[0])).energyPerTick(300).register(plugin);
        ...
        new Quarry(Groups.ADVANCED_MACHINES, ADVANCED_QUARRY, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
                ...
                Materials.MACHINE_CIRCUIT, Materials.MACHINE_CORE, Materials.MACHINE_CIRCUIT
        }, 2, section.getBoolean("cobblestone") ? 4 : 1, outputs.toArray(new Material[0])).energyPerTick(900).register(plugin);
        ...
        new Quarry(Groups.ADVANCED_MACHINES, VOID_QUARRY, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
                ...
                Materials.MACHINE_CIRCUIT, Materials.MACHINE_CORE, Materials.MACHINE_CIRCUIT
        }, 6, section.getBoolean("cobblestone") ? 2 : 1, outputs.toArray(new Material[0])).energyPerTick(3600).register(plugin);
