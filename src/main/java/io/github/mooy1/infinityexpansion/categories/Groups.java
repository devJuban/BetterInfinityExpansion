...
public final class Groups {
    ...
    public static final ItemGroup VOID_MACHINES = new SubGroup("void_machines",
            new CustomItemStack(Material.SMITHING_TABLE, "&8&lVoid &7Machines"));
    ...
    public static final ItemGroup MAIN_CATEGORY = new MultiGroup("main",
            ...
            MAIN_MATERIALS, BASIC_MACHINES, ADVANCED_MACHINES, VOID_MACHINES, STORAGE, MOB_SIMULATION, INFINITY_MATERIALS, INFINITY);
